...
# TODO
# try new model / address video frame size
...
def cumulative_object_counting_x_axis_webcam():
        ...
        while True:
            ...
            if last_detect_tick_count == None or (tick_count - last_detect_tick_count) / tick_freq > OBJECT_DETECT_DELAY:
                ...
                for i in range(num_detections):
                    name = category_index[detections['detection_classes'][i]]['name']
...
if __name__ == "__main__":
    cumulative_object_counting_x_axis_webcam()